...
public class DeleteMethodGenBuilder extends AbstractJavaMapperMethodGenBuilder{

	public DeleteMethodGenBuilder(Configuration configuration, MappedStatement mst, Table introspectedTable) {
