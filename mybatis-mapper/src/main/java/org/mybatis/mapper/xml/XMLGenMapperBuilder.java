...
public class XMLGenMapperBuilder extends BaseBuilder {
	  ...
	  public XMLGenMapperBuilder(InputStream inputStream, Configuration configuration, String resource, Map<String, XNode> sqlFragments, String namespace) {
	    this(inputStream, configuration, resource, sqlFragments);
	    this.builderAssistant.setCurrentNamespace(namespace);
	  }

	  public XMLGenMapperBuilder(InputStream inputStream, Configuration configuration, String resource, Map<String, XNode> sqlFragments) {
	  ...
	  private void buildStatementFromContext(List<XNode> list, String requiredDatabaseId) {
	    for (XNode context : list) {
	      final XMLGenStatementBuilder statementParser = new XMLGenStatementBuilder(configuration, builderAssistant, context, requiredDatabaseId);
	      try {
